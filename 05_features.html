      ...
      <div class="menu__item d-t-none">
        <nav class="menu__center-nav">
          <ul>
            ...
            <li><a href="" class="link link--gray link--gray-active">Features</a></li>
  ...
  <div class="container">
    ...
    <nav class="mobile-menu__wrapper">
      <ul class="mobile-menu__ul">
        ...
        <li class="mobile-menu__li"><a href="" class="link link--dark-gray link--gray-active">Features</a></li>
...
<header class="header-home header-home--color">
  <div class="background background--wave">
    <div class="container background background--right background--features background--header"
      ...
      <div class="row">
        <div class="col-12">
          <h2 class="header-home__title header-home__title--features">The only application you’ll need to power your
            life. <br/> Learn how.</h2>
        </div>
      </div>
    </div>
  </div>
    ...
    <div id="freetrial" class="row about-app about-app--reverse">
      <div class="col-6 about-app__description">
        <div class="about-app__description-content">
          ...
          <h4 class="about-app__description-title">Free Trial</h4>
    ...
    <div id="nosetup" class="row about-app">
      <div class="col-6 about-app__description">
        <div class="about-app__description-content about-app__description-content--left">
          ...
          <h4 class="about-app__description-title">No Setup</h4>
    ...
    <div id="safety" class="row about-app about-app--reverse">
      <div class="col-6 about-app__description">
        <div class="about-app__description-content">
          ...
          <h4 class="about-app__description-title">Safety</h4>
          <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque placerat eros ac finibus congue.
    ...
    <div id="optimized" class="row about-app">
      <div class="col-6 about-app__description">
        <div class="about-app__description-content about-app__description-content--left">
          ...
          <h4 class="about-app__description-title">Optimized Data</h4>
          <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque placerat eros ac finibus congue.
    ...
    <div id="access" class="row about-app about-app--reverse">
      <div class="col-6 about-app__description">
        <div class="about-app__description-content">
          ...
          <h4 class="about-app__description-title">Quick Access</h4>
          <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque placerat eros ac finibus congue.
            Integer consectetur, lorem nec accumsan commodo, sem mauris pharetra arcu, id viverra eros ipsum ac
            lorem. Suspendisse potenti.</p>
        </div>
    ...
    <div id="support" class="row about-app">
      <div class="col-6 about-app__description">
        <div class="about-app__description-content about-app__description-content--left">
          ...
          <h4 class="about-app__description-title">24h Support</h4>
          <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque placerat eros ac finibus congue.
            Integer consectetur, lorem nec accumsan commodo, sem mauris pharetra arcu, id viverra eros ipsum ac
            lorem. Suspendisse potenti. Vestibulum aliquam blandit scelerisque.</p>
        </div>
      </div>
      <div class="col-6 about-app__img">
        <div class="about-app__img-wrap">
